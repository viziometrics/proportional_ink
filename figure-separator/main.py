...
parser.add_argument("--model",default="./figure-separator/data/figure-sepration-model-submitted-544.pb", type=str, help=u"model pb file. Default is ./data/figure-sepration-model-submitted-544.pb")
parser.add_argument("--thresh",default=0.5, type=float, help=u"sub-figuere detection threshold. Default is 0.5")
parser.add_argument("--output",default="./figure-separator/results", type=str, help=u"output directory ./results")
